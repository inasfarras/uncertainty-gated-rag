...
class Settings(BaseSettings):
    ...
    ZERO_RESCUE_MIN_TOKENS: int = 2200
    ZERO_RESCUE_K_BONUS: int = 2

    FORCE_SUPPORT_STOP: bool = True
    OVERLAP_IMPROVEMENT_MIN: float = 0.05
    GATE_RETRIEVAL_K_BONUS: int = 4
    GATE_SEED_MISSING_ANCHORS: bool = True
